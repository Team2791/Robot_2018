...
//				, 66)
	...
	public static class FROM_RIGHT {
		public static final Path TEST_SCALE_RIGHT_FINISH = new Path(
				new PathSegment(t -> 
				/* {"start":{"x":0,"y":50},"mid1":{"x":240,"y":50},"mid2":{"x":242.5,"y":30},"end":{"x":243,"y":68}} */
				(0 + -120 * t + 234 * Math.pow(t, 2))/ (720 + -1425 * t + 706.5 * Math.pow(t, 2)) 
				, 260));
	...
	public static class FROM_RIGHT_PORTAL {
		public static final Path TEST_SCALE_RIGHT = new Path(
				new PathSegment(t -> 
				/* {"start":{"x":0,"y":50},"mid1":{"x":30,"y":50},"mid2":{"x":30,"y":38},"end":{"x":60,"y":38}} */
				(0 + -72 * t + 72 * Math.pow(t, 2))/ (90 + -180 * t + 180 * Math.pow(t, 2)) 
				, 62));
		...
		public static final Path SCALE_RIGHT_TRAVEL = straightLength(205);
		public static final Path SCALE_RIGHT_FINISH = new Path(
				new PathSegment(t -> 
