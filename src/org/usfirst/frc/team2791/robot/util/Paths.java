...
public class Paths {
    //test path is myPath
   public static Path myPath = new Path(
           new PathSegment(t ->
            /* {"start":{"x":0,"y":90},"mid1":{"x":10,"y":90},"mid2":{"x":110,"y":100},"end":{"x":150,"y":195}} */
            (0 + 60 * t + 225 * Math.pow(t, 2))/ (30 + 540 * t + -450 * Math.pow(t, 2))
            , 193)
    );
public static Path rightSwitch = new Path (
        new PathSegment(t ->
                /* {"start":{"x":0,"y":90},"mid1":{"x":60,"y":90},"mid2":{"x":110,"y":100},"end":{"x":150,"y":195}} */
                (0 + 60 * t + 225 * Math.pow(t, 2))/ (180 + -60 * t + 0 * Math.pow(t, 2))
        , 199)
