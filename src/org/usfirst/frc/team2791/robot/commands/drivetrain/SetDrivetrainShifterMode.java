 ...
 *
 */
public class SetDrivetrainShifterMode extends Command {
	private boolean shiftToDrive;

    public SetDrivetrainShifterMode(boolean shiftToDrive) {
//    	requires(Robot.drivetrain);
	...
	// Command. when this is running. Maybe Max S was right about the command based framework.
    	this.shiftToDrive = shiftToDrive;
    }
    ...
    protected void execute() {
    	Robot.drivetrain.setDriveOrRampMode(shiftToDrive);
    }
