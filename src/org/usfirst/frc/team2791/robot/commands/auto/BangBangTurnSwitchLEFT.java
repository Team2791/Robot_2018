...
public class BangBangTurnSwitchLEFT extends CommandGroup {
    ...
    public BangBangTurnSwitchLEFT() {
    	...
    	addSequential(new DriveEncoderBangBang(0.4, 0,  24, 100));
    	addParallel(new SetManipulatorRetracted(true));
    	// turn towards the left side
    	addSequential(new TurnGyroBangBang(-30, -0.3, 100));
    	// drive towards the left side
    	addSequential(new DriveEncoderBangBang(0.4, 0,  36, 100));
    	...
    	addSequential(new DriveEncoderBangBang(0.25, 0,  24, 3));
    	// score
